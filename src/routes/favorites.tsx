  ...
  return (
    <div className="min-h-screen flex flex-col bg-secondary/20">
      ...
      <main className="flex-1 pt-32 pb-24 px-6 max-w-7xl mx-auto w-full">
        ...
        <p className="text-muted-foreground mb-12">Rencanakan liburan Anda selanjutnya dengan kamar-kamar favorit ini.</p>
        ...
        {favoriteRooms.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 bg-card rounded-xl border border-border text-center shadow-sm">
            ...
            <p className="text-muted-foreground mb-8 max-w-md">Silakan telusuri akomodasi kami dan klik ikon hati untuk menyimpannya di sini.</p>
            <Link to="/" className="px-6 py-3 bg-primary text-primary-foreground font-medium rounded-md hover:bg-primary/90 transition-colors">
              Mulai Cari Kamar
            </Link>
          </div>
        ) : (
