      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          ...
          <p className="text-sm text-background/70 max-w-sm leading-relaxed">
            Penginapan elegan di jantung Kota Bogor — perpaduan kenyamanan modern dengan kehangatan
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/rooms" className="hover:text-accent">
                Kamar
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/booking" className="hover:text-accent">
                Pesan Kamar
              </Link>
            </li>
          </ul>
